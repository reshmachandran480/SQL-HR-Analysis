...
/*
ALTER TABLE emp_payment ADD UNIQUE INDEX (
	employee_id,
	date_of_payment
	);
...
ALTER TABLE emp_payment ADD FOREIGN KEY (employee_id) REFERENCES employees(employee_id);
ALTER TABLE emp_payment ADD FOREIGN KEY (department_id) REFERENCES departments(department_id);
